            ...
            >
              ...
              <div className="col-span-3">
                <input
                  ...
                  value={hab.nome}
                  onChange={(e) =>
                    updateHabilidadeParanormal(hab.id, { nome: e.target.value })
                  }
              ...
              <div className="col-span-5">
                <input
                  ...
                  value={hab.descricao}
                  onChange={(e) =>
                    updateHabilidadeParanormal(hab.id, { descricao: e.target.value })
                  }
                  className="w-full bg-transparent border-b border-primary/30 px-1
                           focus:border-primary focus:outline-none text-sm"
                />
            ...
            >
              ...
              <div className="col-span-3">
                <input
                  ...
                  value={hab.nome}
                  onChange={(e) =>
                    updateHabilidadeUnica(hab.id, { nome: e.target.value })
                  }
                  className="w-full bg-transparent border-b border-primary/30 px-1
                           focus:border-primary focus:outline-none text-sm"
                />
              ...
              <div className="col-span-7">
                <input
                  ...
                  value={hab.descricao}
                  onChange={(e) =>
                    updateHabilidadeUnica(hab.id, { descricao: e.target.value })
                  }
                  className="w-full bg-transparent border-b border-primary/30 px-1
                           focus:border-primary focus:outline-none text-sm"
                />
